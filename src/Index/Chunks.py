...
class GitChunk(Chunk):
    def __init__(self, chunk_label: str, cache_dir: Path=Path("/home/XXXX-1/data/gittables")):
...
class DresdenChunk(Chunk):
    def __init__(self, chunk_label: str, cache_dir: Optional[Path]=Path("/home/XXXX-1/data/dwtc")):
        self.cache_dir = cache_dir
        self.temp_dir = None
        super().__init__(chunk_label)
